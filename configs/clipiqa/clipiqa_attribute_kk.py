...
# model settings
model = dict(
    type='CLIPIQA', # mmedit/restorers/clipiqa.py
    # 
    generator=dict(
        ...
        classnames=[
            ...
            ['Accurate color photo.', 'Color case photo.'],
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            img_folder='../dataset/koniq10k/1024x768/',
            ann_file='../dataset/koniq10k/koniq10k_distributions_sets.csv',
